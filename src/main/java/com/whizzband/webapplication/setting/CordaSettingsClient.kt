package com.whizzband.webapplication.setting
 ...
 */
@Component
open class NodeRPCConnectionClient(
    ...
    init {
        val rpcAddress = NetworkHostAndPort(host, 10011)
        val rpcClient = CordaRPCClient(rpcAddress)
        val rpcConnection = rpcClient.start("client", "client")
